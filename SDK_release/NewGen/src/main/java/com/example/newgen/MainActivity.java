...
Module      : Main Module
Description : Enterance point of project. Includes main screen and primary pakages and access controls.
...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public static String getCrewCode(){
        return crewCode;
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (scannedText.equals("001980")) {
                            crewPhoto.setImageResource(R.drawable.suleyman);
                            displayedName.setText("SULEYMAN BAL");
                            crewIdScanned = true;
                            crewCode = "001980";
                        }
                        if (scannedText.equals("001987")) {
                            crewPhoto.setImageResource(R.drawable.tutku);
                            displayedName.setText("TUTKU AKALIN");
                            crewIdScanned = true;
                            crewCode = "001987";
                        }
                        if (scannedText.equals("006815")) {
                            crewPhoto.setImageResource(R.drawable.gamze);
                            displayedName.setText("GAMZE ACET");
                            crewIdScanned = true;
                            crewCode = "006815";
                        }
                        if (scannedText.equals("009120")) {
                            crewPhoto.setImageResource(R.drawable.anastasia);
                            displayedName.setText("ANASTASIA POTAPOVA");
                            crewIdScanned = true;
                            crewCode = "009120";
                        }
                        crewName.setText("");
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (crewIdScanned) {
                            ...
                            Intent myIntent = new Intent(getApplicationContext(), StoreCodeScanActivity.class);
