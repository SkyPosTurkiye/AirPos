...
Module      : Store QR Code Module
Description : Retrieve store data from QR Code
...
public class StoreCodeScanActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    boolean storeQrCodeScanned = false;
    String scannedText = "";
    private final static String SCAN_ACTION = ScanManager.ACTION_DECODE;//default action
    private ImageView scanButton, nextButton, crewPhoto;
    ...
    private List<Product> getProductDataFromJson(JSONObject jSon) {
        ...
        try {
            ...
            AlertDialog alertDialog111 = new AlertDialog.Builder(StoreCodeScanActivity.this).create();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_id_scan);
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        try {
                            ...
                            JSONObject jSonStoreItems = new JSONObject(scannedText);
                            List<Product> currentStoreItems = getProductDataFromJson(jSonStoreItems);
                            Integer currentStoreItemCount = currentStoreItems.size();

                            String itemNameList = "";

                            for (Product object : currentStoreItems) {
                                itemNameList = itemNameList + " ** " + object.getName();
                            }

/*                            AlertDialog alertDialog1 = new AlertDialog.Builder(StoreCodeScanActivity.this).create();
                            alertDialog1.setTitle("Store Item Count");
                            alertDialog1.setMessage("There is " + currentStoreItemCount + " items in this store" + itemNameList);
                            ...
                            alertDialog1.show();*/
                            Intent myIntent = new Intent(getApplicationContext(), FinalizeSale.class);
                            startActivityForResult(myIntent, 0);

                            storeQrCodeScanned = true;
                        } catch (JSONException e) {
                            storeQrCodeScanned = false;
                            AlertDialog alertDialog11 = new AlertDialog.Builder(StoreCodeScanActivity.this).create();
                            alertDialog11.setTitle("Store Code Read Error");
                            alertDialog11.setMessage("Problem is: " + e);
                            alertDialog11.setButton(AlertDialog.BUTTON_NEUTRAL, "OK",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.dismiss();
                                        }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (action) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        break;
                    case MotionEvent.ACTION_UP:
                        if (!storeQrCodeScanned) {
                            nextButton.setImageResource(R.drawable.next_up);
                            AlertDialog alertDialog = new AlertDialog.Builder(StoreCodeScanActivity.this).create();
                            alertDialog.setTitle("WARNING");
                            alertDialog.setMessage("All items will be unlocked for sale but this sale will not be connected to a flight!!! Pls inform LMP staff in written!!!");
        ...
        scanResult2.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    Toast.makeText(StoreCodeScanActivity.this, "EditorAction DNOE event", Toast.LENGTH_LONG).show();
                    return true;
                }
                return false;
            }
